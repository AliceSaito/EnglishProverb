...
let proverbs: Array<Dictionary<String,String>> = [
    ...
    ["question_en": "If you chase two rabbits, you will not catch neither.","number": "21" ,"question_jp": "二兎を追う者は一兎も得ず", "answer_a": "neither","answer_b": "any","answer_c": "both","correct": "neither","explanation": "\"neither\"は2つのものの中から「どちらでもない」と言いたいときに使います。\"any \"は対象となる事柄が3つ以上の場合に使用します。"],
